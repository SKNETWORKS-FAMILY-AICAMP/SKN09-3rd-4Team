...
| [@김도연](https://github.com/doyeon158)  | [@김우중](https://github.com/)  | [@김정훈](https://github.com/)  | [@이윤재](https://github.com/Leeyoonjae)   |
...
| 직업           | 마케팅 팀 대리 |
| 거주지         | 서울 강남구 |
| 여행 목적      | 친구들과 함께한 제주도 3박 4일 국내여행 |
| 여행 특징      | 렌터카 이용, 액티비티(서핑, 오름 등산), 맛집 탐방 |
| 보험 가입 경로 | 출발 전 온라인으로 국내여행자 보험 가입 (모바일) |
| 우려 상황      | 렌터카 이용 중 발생할 수 있는 사고, 병원 치료비 부담 |
| 실제 상황      | 여행 중 운전하다가 가벼운 접촉사고 발생, 찰과상 치료 필요 |
| 질문 유형      | “이런 사고도 보험 처리 가능한가요?”, “자동차 보험 말고 여행자 보험으로 가능해요?” 
...
| 2 | 국내 여행지에서 식중독 걸려서 병원 다녀왔는데 보상되나요? | . |(국내여행보험)
식중독도 여행 중 발생한 질병으로 간주되어 의료비 보상 가능 | T/F | xx 초 |
...
| No.       | 개선 내용        | 설명                            | 실제 응답            |
|----------------|------------------|----------------------------------|-----------------|
| 테스트 문장    |       |       |  "경주 여행 중 넘어져 치아를 부러졌는데 보철비도 보상되나요?" |
| 2 | 임베딩 모델 교체  | 질문 및 문서 임베딩 처리         |    |
| 3 | 프롬프트 엔지니어링 | llm모델에 프롬프트 명시  |  |
| 4 | 파인튜닝 | ...  | Top-k 검색 사용 |
